...
const variants: Record<Variant, string> = {
  ...
  success:
    'bg-success hover:bg-success/85 text-white border border-success/50 shadow-lg shadow-success/25',
  // Finalização de venda fiscal — azul operacional
  fiscal:
    'bg-info hover:bg-info/80 text-white border border-info/50 shadow-lg shadow-info/25',
  // Finalização de pedido gerencial — âmbar sólido
  warning:
    'bg-warning hover:bg-warning/80 text-white border border-warning/50 shadow-lg shadow-warning/25',
}
